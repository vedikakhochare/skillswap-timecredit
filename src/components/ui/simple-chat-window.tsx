...
import { SimpleMessageBubble } from "@/components/ui/simple-message-bubble";
import { ChatInput } from "@/components/ui/chat-input";
import { SimpleMessage, SimpleConversation } from "@/lib/simpleMessagingService";
  ...
  useEffect(() => {
    if (conversation) {
      ...
      if (otherParticipantId) {
        const participantName = conversation.participantNames?.[otherParticipantId] || "Unknown User";
        const participantAvatar = conversation.participantAvatars?.[otherParticipantId];
        setParticipantName(participantName);
        setParticipantAvatar(participantAvatar);
      }
    }
